...
${OBJECTDIR}/bitArray.o: bitArray.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bitArray.o bitArray.cpp

${OBJECTDIR}/crossValidate.o: crossValidate.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/crossValidate.o crossValidate.cpp
...
${OBJECTDIR}/treeSingleDirection.o: treeSingleDirection.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/treeSingleDirection.o treeSingleDirection.cpp
